...
vim.keymap.set({'v'}, '<down>', ":m  '>+1<CR>gv=gv", { silent = true, desc = "Move lines down in visual selection mode" })
vim.keymap.set({'v'}, '<up>', ":m  '<-2<CR>gv=gv", { silent = true, desc = "Move lines up in visual selection mode" })
